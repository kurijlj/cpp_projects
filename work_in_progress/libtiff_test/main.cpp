...
// ============================================================================
//
// 2021-02-01 Ljubomir Kurij <ljubomir_kurij@protonmail.com>
//
// * main.cpp: created.
//
// ============================================================================
...
#include <TIFFManipulate.hpp>  // required for operations on TIFF files
...
const std::string kAppName = "libtiff_test";
...
int main(int argc, char *argv[])
{
    ...
    if(tiff.Open(validators.input_file.value().c_str(), "r")) {
        tiff.Close();
