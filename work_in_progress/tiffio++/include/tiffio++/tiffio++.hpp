...
public:
    ...
    ///////////////////////////////////////////////////////////////////////////
    //
    // File Access Flags  - libtiff distincts fthree types of file access mode:
    //
    //     a  - append
    //     r  - read
    //     w  - write
...
public:
    // Constructors
    TOFFIOObject();
    TOFFIOObject(const std::string file_name);
...
{
    // file_access_mode_ = TIFFIOObject::ReadMode();
    file_name_ = "";
    file_opened_ = false;
    print_errors_ = true;
...
TIFFIOObject::TIFFIOObject(
        ...
        // const FileAccessMode file_access_mode = TIFFIOObject::ReadMode()
        )
{
